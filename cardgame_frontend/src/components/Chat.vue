<template>
    <div class="chat-container">
      <div class="chat-border" :class="{ bottom: hideChat }">
        <p>Chatta</p>
      ...
      <div class="chat-window-and-input" :class="{ invisible: hideChat }">
        <div class="chat-window">
          <div v-for="message in chatMessages" :key="message.id">
            <ChatMessage
              :message="message"
              :class="{ right: message.color == 'blue' }"
              class="chat-message"
            />
          </div>
        </div>
