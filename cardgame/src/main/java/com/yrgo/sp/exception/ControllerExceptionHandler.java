...
public class ControllerExceptionHandler {
	...
	public ErrorMessage cardNotFoundException(CardNotFoundException exception, WebRequest request) {
		ErrorMessage msg = new ErrorMessage(HttpStatus.NOT_FOUND.value(), new Date(), exception.getMessage(),
	...
	public ErrorMessage globalExceptionHandler(Exception e, WebRequest request) {
		ErrorMessage msg = new ErrorMessage(HttpStatus.INTERNAL_SERVER_ERROR.value(), new Date(), e.getMessage(),
				request.getDescription(false));
		return msg;
	}
}
