...
/*
  Set<Card> cardList = new HashSet<Card>(); Card card1 = new Card("Blandkost",
  2000); card1.setBackImage("http://localhost:8080/images/Kort1_back.jpg");
  card1.setFrontImage("http://localhost:8080/images/Kort1_front.jpg");
  card1.setSubtitle("Svenskt genomsnitt"); card1.setFrequence(365);
  ...
  card2.setSubtitle(null); card2.setFrequence(365); card2.setDescription(
  "1 års mat för en genomsnittlig svensk vegetarian, protein från växter, ägg och mjölkprodukter"
  ); card2.setExtraInfo("Utsläpp från mjölkprodukter: 50%"); card2.setId(2l);
  ...
  card3.setSubtitle(null); card3.setFrequence(365); card3.setDescription(
  "två ostmackor med smör om dagen under ett år"); card3.setExtraInfo(
  "Utsläpp från ost: 50%, smör: 35%"); card3.setId(3l);
  ...
  card4.setSubtitle(null); card4.setFrequence(365); card4.setDescription(
  "två äggmackor med margarin om dagen under ett år"); card4.setExtraInfo(
  "Utsläpp från ägg: 70%, margarin: 10%"); card4.setId(4l);
  ...
  card5.setSubtitle("med müsli"); card5.setFrequence(365);
  card5.setDescription( "En tallrik yoghurt med müsli varje dag under ett år");
  card5.setExtraInfo( "Utsläpp från yoghurt: 70%"); card5.setId(5l);
  ...
  card6.setSubtitle("med havremjölk"); card6.setFrequence(365);
  card6.setDescription(
  "En tallrik havregrynsgröt med havremjölk varje dag under ett år");
  card6.setExtraInfo( null); card6.setId(6l);
  ...
  card7.setSubtitle(null); card7.setFrequence(365); card7.setDescription(
  "En halloumiburgare eller annan ostrik måltid varje dafg under ett år");
  card7.setExtraInfo( "Utsläpp av metan: 40%"); card7.setId(7l);
  
  
  cardList.add(card1); cardList.add(card2); cardList.add(card3);
  cardList.add(card4); cardList.add(card5); cardList.add(card6);
  cardList.add(card7);
